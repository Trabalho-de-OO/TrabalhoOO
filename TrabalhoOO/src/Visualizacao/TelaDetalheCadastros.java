...
public class TelaDetalheCadastros implements ActionListener{
	...
	public TelaDetalheCadastros() {
		//JFrame
		janelaDetalhe = new JFrame();
		janelaDetalhe.setBounds(483 ,159, 500 , 450);	
	...
	public static void main(String[]args) {
		TelaDetalheCadastros tela = new TelaDetalheCadastros();
	}
